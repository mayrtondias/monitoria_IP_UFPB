...
int main(){
	...
	/*observe atentamente que a Linguagem C trata o valor dentro da condi��o do 
	...
	no entanto, temos o operador ! de negac�o a frente de toda expressao faz com
	...
	ent�o ela retornara verdadeiro, logo apos essa avaliacao sera verificado o operador
	...
	diferente de 5, contudo por se tratar de um ou a expressao final ser� verdadeira.*/
