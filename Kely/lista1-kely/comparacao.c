...
o if-else a fim de observar, se as mesmas sao verdadeiras ou falsa. 
*/

int main(){
	// Declaracao das variaveis que serao avaliadas pelos if's
	int i=1, j=2, k=3, n=2;
	float x=3.3, y=4.4;
	...
	*/
	...
	passos sera avaliado se 1.0 e' maior ou igual a 8.8 que sera falsa executando
	...
	*/
	...
	/* Observe atentamente que a Linguagem C trata o valor dentro da condicao do 
	...
	no entanto, temos o operador ! de negacao a frente de toda expressao faz com
	...
	*/
	...
	entao ela retornara verdadeiro, logo apos essa avaliacao sera verificado o operador
	...
	*/
	...
	a comparacao se j e igual a 4 e falsa, mas como a primeira e verdadeira, ent�o 
	o primeiro ou retornara verdadeiro e a ultima parte tambem e falsa pois de k e 
	diferente de 5, contudo por se tratar de um ou a expressao final sera verdadeira.
	*/
